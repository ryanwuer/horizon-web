export default {
  ...
  'pages.navigation.vmDeploy': 'Deploy VM',
  'pages.navigation.vmDeploy.desc': 'Deploy virtual machine instance using Horizon',
  ...
  'pages.catalog.virtual_machine': 'Virtual Machine',
  ...
  'pages.applicationDetail.basic.upgrade': 'Upgrade',
  ...
  'pages.applicationUpgrade.success': 'Upgrade application successfully',
  'pages.applicationUpgrade.confirm.title': 'Are you sure to upgrade this application: {application}?',
  'pages.applicationUpgrade.confirm.content': 'Experience a more universal and language-agnostic template system',
  'pages.applicationUpgrade.confirm.ok': 'OK',
  'pages.applicationUpgrade.confirm.cancel': 'Cancel',
  ...
  'pages.danger.confirm.cancel': 'Cancel',
  'pages.danger.confirm.error': 'Please write down {requiredString} to confirm',
  'pages.danger.confirm.confirm': 'Please write down below texts to confirm:',
  ...
  'pages.cluster.vmTable.nodata.title': 'No VM',
  'pages.cluster.vmTable.nodata.desc': 'No VM found, possibly due to replica count being scaled down to 0 or the instance not being deployed, please check replica count in instance\'s configuration and cluster status.',
  'pages.cluster.vmTable.hostname': 'Hostname',
  'pages.cluster.vmTable.events': 'Events',
  'pages.cluster.vmTable.events.type': 'Type',
  'pages.cluster.vmTable.events.reason': 'Reason',
  'pages.cluster.vmTable.events.message': 'Message',
  'pages.cluster.vmTable.events.count': 'Count',
  'pages.cluster.vmTable.events.time': 'Time',
  'pages.cluster.vmTable.newVMs': 'New vms',
  'pages.cluster.vmTable.oldVMs': 'Old vms',
  'pages.cluster.vmTable.vmStatus': 'Status',
  'pages.cluster.vmTable.containerName': 'Container name',
  'pages.cluster.vmTable.containerStatus': 'Container status',
  'pages.cluster.vmTable.ready': 'Ready',
  'pages.cluster.vmTable.ready.unknown.description': 'Readiness probe not configured yet, online status unknown',
  'pages.cluster.vmTable.container.ready': 'Ready',
  'pages.cluster.vmTable.ready.notready': 'Not Ready',
  'pages.cluster.vmTable.onlineStatus': 'Online status',
  'pages.cluster.vmTable.restartCount': 'Restarts',
  'pages.cluster.vmTable.annotations': 'Annotations',
  'pages.cluster.vmTable.createdAt': 'Created at',
  'pages.cluster.vmTable.terminal': 'Terminal',
  'pages.cluster.vmTable.monitor': 'Monitor',
  'pages.cluster.vmTable.more': 'More',
  'pages.cluster.vmTable.more.stdout': 'Stdout',
  'pages.cluster.vmTable.more.events': 'Events',
  'pages.cluster.vmTable.online': 'Online',
  'pages.cluster.vmTable.offline': 'Offline',
  'pages.cluster.vmTable.restartVM': 'Restart',
  'pages.cluster.vmTable.delete': 'Delete',
  'pages.cluster.vmTable.operation.result': 'Operation result',
  'pages.cluster.vmTable.operation.successList': 'Success list',
  'pages.cluster.vmTable.operation.failList': 'Failure list',
  'pages.cluster.vmTable.statusDetail': 'Status detail info',
  'pages.cluster.vmTable.statusDetail.type': 'Type',
  'pages.cluster.vmTable.statusDetail.task': 'Task',
  'pages.cluster.vmTable.statusDetail.message': 'Message',
  'pages.cluster.vmTable.lifeCycle.podSchedule': 'VM scheduling',
  'pages.cluster.vmTable.lifeCycle.podInitialize': 'VM initialization',
  'pages.cluster.vmTable.lifeCycle.containerStartup': 'Service startup and port check',
  'pages.cluster.vmTable.lifeCycle.containerOnline': 'Service online',
  'pages.cluster.vmTable.lifeCycle.healthCheck': 'Health check',
  'pages.cluster.vmTable.lifeCycle.preStop': 'Service offline',
  ...
  'pages.cluster.monitor.last.1d': 'Last 1 day',
  'pages.cluster.monitor.last.3d': 'Last 3 days',
  ...
  'pages.cluster.action.reusedBuildDeploy': 'Reused build and deploy',
  ...
  'pages.message.cluster.free.title': 'Are you sure to free the application instance?',
  ...
  'pages.message.cluster.delete.title': 'Are you sure to delete the application instance?',
  ...
  'pages.message.cluster.deployCancel.first.content2': 'Cannot cancel. Please free the application instance manually',
