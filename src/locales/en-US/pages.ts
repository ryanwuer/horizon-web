export default {
  ...
  'pages.cluster.vmTable.name': 'VM Name',
  'pages.cluster.vmTable.status': 'Status',
  'pages.cluster.vmTable.ip': 'IP Address',
  'pages.cluster.vmTable.node': 'Node',
  'pages.cluster.vmTable.lifecycle': 'Lifecycle',
  'pages.cluster.vmTable.operations': 'Operations',
  'pages.cluster.vmTable.terminal': 'Terminal',
  'pages.cluster.vmTable.monitor': 'Monitor',
  'pages.cluster.vmTable.events': 'Events',
  'pages.cluster.vmTable.containerMonitor': 'Container Monitor',
  'pages.cluster.vmTable.more': 'More',
  'pages.cluster.vmTable.restart': 'Restart',
  'pages.cluster.vmTable.search.placeholder': 'Search VMs...',
  'pages.cluster.vmTable.copyNames': 'Copy Names',
  'pages.cluster.vmTable.copyName': 'Copy Name',
  'pages.cluster.vmTable.selected': 'Selected {num} items',
  'pages.cluster.vmTable.delete': 'Destroy and Recreate',
